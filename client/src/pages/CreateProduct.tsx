      ...
      toast({
        ...
        description: (
          <p>
            ...
            éxito y se ha registrado el movimiento de entrada correspondiente.{' '}
            <br />
            <strong>
            ...
            <Form {...form}>
              ...
              >
                ...
                <div className='row-span-6 flex flex-col justify-between'>
                  ...
                  />
                  <Alert className='col-span-3 bg-muted/50'>
                    <AlertDescription className='text-xs text-muted-foreground'>
                      Al crear el producto con stock inicial, se registrará automáticamente un movimiento de entrada en el inventario.
                    </AlertDescription>
                  </Alert>
                  <FormField
                    control={form.control}
